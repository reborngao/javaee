...
(function(window, undefined) {
	...
	jQuery.Event = function(src, props) {
		...
		if (src && src.type) {
			...
			this.isDefaultPrevented = (src.defaultPrevented
					|| src.returnValue === false || src.defaultPrevented
	...
	jQuery.each(fxAttrs.concat.apply([], fxAttrs), function(i, prop) {
		// exclude marginTop, marginLeft, marginBottom and marginRight from this
		// list
									...
									.access(
											...
											function(elem, type, value) {
												...
												if (jQuery.isWindow(elem)) {
													// 3rd condition allows
													// Nokia support, as it
													// supports the docElem prop
													// but not CSS1Compat
													doc = elem.document;
												...
												if (elem.nodeType === 9) {
													// Either
													// scroll[Width/Height] or
													// offset[Width/Height],
													// whichever is greater
													doc = elem.documentElement;

													// when a window > document,
													// IE6 reports a
													// offset[Width/Height] >
													// client[Width/Height]
													// so we can't use max, as
													// it'll choose the
													// incorrect
													// offset[Width/Height]
													// instead we use the
